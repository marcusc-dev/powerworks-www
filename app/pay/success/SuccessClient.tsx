    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="flex justify-center">
          <Image src="/full_logo.png" alt="Powerworks Garage" width={180} height={54} priority />
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white border-2 border-gray-200 text-gray-700 font-semibold text-sm hover:border-power-blue hover:text-power-blue transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white border-2 border-gray-200 text-gray-700 font-semibold text-sm hover:border-[#00b67a] hover:text-[#00b67a] transition-all"
            >
